...
client.on('message', function(message){ 
    ...
    if(message.content.startsWith('/funny')){randomnumbergenerated = Math.floor((Math.random() * 100))
        message.channel.send(funny2[randomnumbergenerated])
    }
    if (message.content.startsWith('/rolldice 20')){randomnumbergenerated = Math.floor((Math.random() * 20))
        message.reply([randomnumbergenerated])
    }
    if (message.content.startsWith('/roll d20')){randomnumbergenerated = Math.floor((Math.random() * 20))
        message.reply([randomnumbergenerated])
    }
    if (message.content.startsWith('/rolld20')){randomnumbergenerated = Math.floor((Math.random() * 20))
        message.reply([randomnumbergenerated])
    }
    if (message.content.startsWith('/rolldice 12')){randomnumbergenerated = Math.floor((Math.random() *12))
        message.reply([randomnumbergenerated])
    }
    if (message.content.startsWith('/roll d12')){randomnumbergenerated = Math.floor((Math.random() *12))
        message.reply([randomnumbergenerated])
    }
    if (message.content.startsWith('/rolld12')){randomnumbergenerated = Math.floor((Math.random() *12))
        message.reply([randomnumbergenerated])
    }
    if (message.content.startsWith('/rolldice 6')){randomnumbergenerated = Math.floor((Math.random() * 6))
        message.reply([randomnumbergenerated])
    }
    if (message.content.startsWith('/roll d6')){randomnumbergenerated = Math.floor((Math.random() * 6))
        message.reply([randomnumbergenerated])
    }
    if (message.content.startsWith('/rolld6')){randomnumbergenerated = Math.floor((Math.random() * 6))
        message.reply([randomnumbergenerated])
    }
    if (message.content.startsWith('/rolldice 4')){randomnumbergenerated = Math.floor((Math.random() *4))
        message.reply([randomnumbergenerated])
    }
    if (message.content.startsWith('/roll d4')){randomnumbergenerated = Math.floor((Math.random() *4))
        message.reply([randomnumbergenerated])
    }
    if (message.content.startsWith('/rolld4')){randomnumbergenerated = Math.floor((Math.random() *4))
        message.reply([randomnumbergenerated])
    }
